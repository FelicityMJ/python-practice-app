import { REVISION_CARDS, FLUENCY_SPRINTS } from "./revision-fluency-v8-1-1.js";
...
function renderPathway() {
  ...
  elements.continueActivityButton.textContent = firstIncomplete
    ? `Continue ${selectedArea?.shortTitle || "course"} pathway`
    : "Pathway complete";
  elements.continueActivityButton.setAttribute("aria-label", firstIncomplete
    ? `Continue to ${firstIncomplete.title}`
    : "Pathway complete");
