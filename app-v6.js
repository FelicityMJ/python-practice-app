...
const DDD_ACTIVITIES = [
  {
    ...
    "required": true,
    "estimatedMinutes": 6,
    "contentHtml": "<p>A database is an organised collection of related data. An <strong>entity</strong> is the person, place, object or event being described. An <strong>attribute</strong> is one detail stored about that entity.</p>\n<div class=\"ddd-mini-table\"><div><strong>Entity: Pupil</strong></div><div>pupilID</div><div>forename</div><div>className</div></div>\n<p>Each row is a <strong>record</strong>. Each column is a <strong>field</strong> or attribute.</p>",
    "checkpoint": {
      "prompt": "Which word describes one complete row about a pupil?",
      "options": [
        "Record",
        "Field",
        "Entity relationship"
      ...
      "answer": 0,
      "explanation": "A record contains all the stored field values for one item."
    }
  },
  {
    "id": "DDD-01-02",
  ...
  },
  {
    ...
    "checkpoint": {
      ...
      "answer": 0,
      "explanation": "Only necessary data should be collected."
    }
  },
  {
    "id": "DDD-07-02",
