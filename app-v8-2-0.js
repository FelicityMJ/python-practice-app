...
function renderLearningRouteControls() {
  ...
  elements.learningRouteNotice.innerHTML = accelerator
    ? "<strong>Exam Accelerator:</strong> every topic remains available, but each unit is shortened to a rapid explanation, essential application, retrieval check and exam-focused task. Progress still counts towards the same mastery profile."
