...
,
  ...
  },
  {
    ...
    "videoUrl": "",
    "contentHtml": "<ul><li><strong>Syntax error:</strong> Python cannot understand the code, such as a missing colon or quotation mark.</li><li><strong>Execution error:</strong> the program starts but crashes, such as an invalid index or undefined name.</li><li><strong>Logic error:</strong> the program runs but produces the wrong result.</li></ul><p>Read the full traceback. A highlighted line may be affected by a missing bracket or quote on the line above.</p>",
    "checkpoint": {
  ...
  },
  {
    ...
    "questions": [
      ...
      {
        "prompt": "Which error type includes NameError and IndexError?",
        "options": [
          "Execution error",
          "Logic error",
          "Testing data"
        ...
        "answer": 0,
        "explanation": "They arise while the program executes."
      },
      {
...
function memberLastActiveMillis(classItem, userId) {
  ...
  return Math.max(0, ...progressTimes, ...reviewTimes, ...sessionTimes);
}
...
function skillEvidenceForPupil(classItem, userId, skillId) {
  ...
  const combined = [...reviewEvidence, ...progressEvidence]
    .sort((a, b) => b.at - a.at)
    .slice(0, 6);
