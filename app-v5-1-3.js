...
function showDebugGameOver() {
  ...
  // A unique query value restarts the animated GIF each time it is shown.
  elements.debugGameOverGif.src = `game_over.gif?play=${Date.now()}`;
  elements.debugGameOverOverlay.classList.remove("hidden");

  // The original animation contains 43 frames at roughly 100 ms each.
